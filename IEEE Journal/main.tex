...
Cette fonction nous permets de avoir .....
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Cas d’un perceptron multicouche : implementations}\blindtext
\begin{figure}[h]
	\centering
...
\blindtext
%todo foto de las curvas de convregencia
\begin{figure}[h]
	\centering
	\includegraphics[width=2.5in]{logo}
	%TODO change the image and the caption and label
...
\begin{figure}[h]
	\centering
	\includegraphics[width=2.5in]{../OctaveNeurons/rs32}
	%TODO change the image and the caption and label
	\caption{Simulation Results}
	\label{fig_sim}
\end{figure}
