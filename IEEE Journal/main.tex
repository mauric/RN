...
On a utilisé la fonction sigmoide comme fonction de transition. La fonction de activation est la fonction produit escalaire. Les connections entre neurones est faite par le bias du poids. Si la connections a un poid negative est une connection dite \textit{exhibitrice} si est positif est dite \textit{excitatrice}
\subsection{Le perceptron : fonctions de transition classiques}\blindtext
\subsection{Le perceptron : rôle de l’unité de biais}\blindtext
...
\section{L’apprentissage supervisé}\blindtext
...
\subsection{Cas d’un perceptron multicouche : calcul du vecteur gradient}\blindtext
...
\section{Quelques règles à suivre...si on veut que cela converge}\blindtext
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Technique 3 and resultats}\blindtext
